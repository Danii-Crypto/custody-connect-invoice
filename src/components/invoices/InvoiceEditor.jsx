              ...
              <div key={idx} className="space-y-3 py-3 border-b border-border/40 last:border-0">
                      ...
                      <div className="grid grid-cols-3 gap-3 items-end">
                        <div>
                          ...
                          <Input type="number" value={item.quantity} onChange={(e) => updateLine(idx, "quantity", e.target.value)} className="h-8 text-center [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none text-sm file:text-sm md:text-sm pt-1 pr-2 pb-1 pl-2" />
                        </div>
                        <div>
